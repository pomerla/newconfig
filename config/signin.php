...
<meta name="author" content="GreyGler" />
 ...
 <!-- HTML5 Shim and Respond.js IE8 support of HTML5 elements and media queries -->
  ...
  <h1><strong>Конфигуратор</strong><br><small><a title="Перейти к сайту" href="<?= $scheme.'://'.$_SERVER['SERVER_NAME'].str_ireplace('/config/signin.php','', $_SERVER['PHP_SELF']); ?>"><?= $scheme.'://'.$_SERVER['SERVER_NAME'].str_ireplace('/config/signin.php','', $_SERVER['PHP_SELF']); ?></a></small></h1>
</div>
