...
if ($_FILES["upsel_pic_2"]["name"]!="") {if (!file_exists($ups_pic_dir)) mkdir($ups_pic_dir); move_uploaded_file($_FILES["upsel_pic_2"]["tmp_name"], $ups_pic_dir.$_FILES["upsel_pic_2"]["name"]);
}
if ($_FILES["upsel_pic_3"]["name"]!="") {if (!file_exists($ups_pic_dir)) mkdir($ups_pic_dir); move_uploaded_file($_FILES["upsel_pic_3"]["tmp_name"], $ups_pic_dir.$_FILES["upsel_pic_3"]["name"]);
}
if ($_FILES["upsel_pic_4"]["name"]!="") {if (!file_exists($ups_pic_dir)) mkdir($ups_pic_dir); move_uploaded_file($_FILES["upsel_pic_4"]["tmp_name"], $ups_pic_dir.$_FILES["upsel_pic_4"]["name"]);
}
if ($_FILES["upsel_pic_5"]["name"]!="") {if (!file_exists($ups_pic_dir)) mkdir($ups_pic_dir); move_uploaded_file($_FILES["upsel_pic_5"]["tmp_name"], $ups_pic_dir.$_FILES["upsel_pic_5"]["name"]);
}
...
if ($_FILES["upsel_pic_2"]["name"]!=""){
$text.="$"."upsel_pic_2 = '{$_FILES["upsel_pic_2"]["name"]}';\n"; 
$text2.="$"."upsel_pic_2 = '{$_FILES["upsel_pic_2"]["name"]}';\n";
}

if ($_FILES["upsel_pic_3"]["name"]!=""){
$text.="$"."upsel_pic_3 = '{$_FILES["upsel_pic_3"]["name"]}';\n"; 
$text2.="$"."upsel_pic_3 = '{$_FILES["upsel_pic_3"]["name"]}';\n";
}
if ($_FILES["upsel_pic_4"]["name"]!=""){
$text.="$"."upsel_pic_4 = '{$_FILES["upsel_pic_4"]["name"]}';\n"; 
$text2.="$"."upsel_pic_4 = '{$_FILES["upsel_pic_4"]["name"]}';\n";
}
if ($_FILES["upsel_pic_5"]["name"]!=""){
$text.="$"."upsel_pic_5 = '{$_FILES["upsel_pic_5"]["name"]}';\n"; 
$text2.="$"."upsel_pic_5 = '{$_FILES["upsel_pic_5"]["name"]}';\n";
}
