...
function upscr_2() {
	if ($('#upsel_2').val()==0){
		$('#upsel_title_2').prop('disabled',true);
		$('#upsel_pic_2').prop('disabled',true);
		$('#upsel_pic_h_2').prop('disabled',true);
		$('#upsel_url_2').prop('disabled',true);
		$('#upsel_url_title_2').prop('disabled',true);
		$('#upsel_delay_2').prop('disabled',true);
		$('#ups_2').addClass('hidden');
	} else {
		$('#upsel_title_2').prop('disabled',false);
		$('#upsel_pic_2').prop('disabled',false);
		$('#upsel_pic_h_2').prop('disabled',false);
		$('#upsel_url_2').prop('disabled',false);
		$('#upsel_url_title_2').prop('disabled',false);
		$('#upsel_delay_2').prop('disabled',false);
		$('#ups_2').removeClass('hidden');
	}
...
function upscr_3() {
	if ($('#upsel_3').val()==0){
		$('#upsel_title_3').prop('disabled',true);
		$('#upsel_pic_3').prop('disabled',true);
		$('#upsel_pic_h_3').prop('disabled',true);
		$('#upsel_url_3').prop('disabled',true);
		$('#upsel_url_title_3').prop('disabled',true);
		$('#upsel_delay_3').prop('disabled',true);
		$('#ups_3').addClass('hidden');
	} else {
		$('#upsel_title_3').prop('disabled',false);
		$('#upsel_pic_3').prop('disabled',false);
		$('#upsel_pic_h_3').prop('disabled',false);
		$('#upsel_url_3').prop('disabled',false);
		$('#upsel_url_title_3').prop('disabled',false);
		$('#upsel_delay_3').prop('disabled',false);
		$('#ups_3').removeClass('hidden');
	}
...
function upscr_4() {
	if ($('#upsel_4').val()==0){
		$('#upsel_title_4').prop('disabled',true);
		$('#upsel_pic_4').prop('disabled',true);
		$('#upsel_pic_h_4').prop('disabled',true);
		$('#upsel_url_4').prop('disabled',true);
		$('#upsel_url_title_4').prop('disabled',true);
		$('#upsel_delay_4').prop('disabled',true);
		$('#ups_4').addClass('hidden');
	} else {
		$('#upsel_title_4').prop('disabled',false);
		$('#upsel_pic_4').prop('disabled',false);
		$('#upsel_pic_h_4').prop('disabled',false);
		$('#upsel_url_4').prop('disabled',false);
		$('#upsel_url_title_4').prop('disabled',false);
		$('#upsel_delay_4').prop('disabled',false);
		$('#ups_4').removeClass('hidden');
	}
...
function upscr_5() {
	if ($('#upsel_5').val()==0){
		$('#upsel_title_5').prop('disabled',true);
		$('#upsel_pic_5').prop('disabled',true);
		$('#upsel_pic_h_5').prop('disabled',true);
		$('#upsel_url_5').prop('disabled',true);
		$('#upsel_url_title_5').prop('disabled',true);
		$('#upsel_delay_5').prop('disabled',true);
		$('#ups_5').addClass('hidden');
	} else {
		$('#upsel_title_5').prop('disabled',false);
		$('#upsel_pic_5').prop('disabled',false);
		$('#upsel_pic_h_5').prop('disabled',false);
		$('#upsel_url_5').prop('disabled',false);
		$('#upsel_url_title_5').prop('disabled',false);
		$('#upsel_delay_5').prop('disabled',false);
		$('#ups_5').removeClass('hidden');
	}
...
function upspicscr_1(){
	$('#upsel_pic_1').removeClass('hidden');
	$('#upsel_pic_p_1').addClass('hidden');
	$('#on_upsell_pic_1').addClass('hidden');
	$('#upsel_pic_1').prop('disabled',false);
	$('#ups_pic_1').prop('value','').prop('name','');
	
}
function upspicscr_2(){
	$('#upsel_pic_2').removeClass('hidden');
	$('#upsel_pic_p_2').addClass('hidden');
	$('#on_upsell_pic_2').addClass('hidden');
	$('#upsel_pic_2').prop('disabled',false);
	$('#ups_pic_2').prop('value','').prop('name','');
	
}
function upspicscr_3(){
	$('#upsel_pic_3').removeClass('hidden');
	$('#upsel_pic_p_3').addClass('hidden');
	$('#on_upsell_pic_3').addClass('hidden');
	$('#upsel_pic_3').prop('disabled',false);
	$('#ups_pic_3').prop('value','').prop('name','');
	
}
function upspicscr_4(){
	$('#upsel_pic_4').removeClass('hidden');
	$('#upsel_pic_p_4').addClass('hidden');
	$('#on_upsell_pic_4').addClass('hidden');
	$('#upsel_pic_4').prop('disabled',false);
	$('#ups_pic_4').prop('value','').prop('name','');
	
}
function upspicscr_5(){
	$('#upsel_pic_5').removeClass('hidden');
	$('#upsel_pic_p_5').addClass('hidden');
	$('#on_upsell_pic_5').addClass('hidden');
	$('#upsel_pic_5').prop('disabled',false);
	$('#ups_pic_5').prop('value','').prop('name','');
