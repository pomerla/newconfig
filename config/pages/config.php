...
<div class="form-group text-center">
  ...
  <div id="telegram-block" class="panel-collapse collapse">
   <div class="panel-body">
	  ...
	  <div class="form-group">
    <label class="col-sm-3 control-label">ID @CollLeadBot: </label><div class="col-sm-9"><input group="tlg" class="form-control" id="tele_id" type="number" name="tele_id" value="<?php echo  $tele_id ?>" placeholder="Ваш ID в телеграм-боте @CoolLeadBot">
...
<span class="help-block">	  Для указания ссылки используйте переменную <strong><i>%back_link%</i></strong>.</span>
  ...
  <div class="panel-heading">
   <h4 class="panel-title"> <i class="fa fa-cart-plus"></i>&#160;
       <a data-toggle="collapse" data-parent="#accordion" href="#upsell-block-1">
       1 Допродажа на странице "СПАСИБО." :&#160;</a>&#160;<i class="fa fa-caret-down" aria-hidden="true"></i>
	   <span id="upsell" class="panel-heading-info hidden"><small>Есть не заполненные поля!</small></span>
      </h4>
  </div>
  <div id="upsell-block-1" class="panel-collapse collapse">
   <div class="panel-body">
	  <fieldset>
	   	 <legend><small>1 Блок допродажи на странице "спасибо"</small></legend>
	  <div class="form-group">
...
<div class="col-sm-9"><input group="upsell"  value="none"  class="form-control <? if ($upsel_pic!="") echo "hidden" ?>" <? if ($upsel_pic!="") echo "disabled" ?> id="upsel_pic" <? if ($upsel!='1') echo ("disabled") ?> type="file" name="upsel_pic" accept="image/*" size="20" required >
...
<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Old prise: <em>*</em></label><div class="col-sm-9"><input group="upsel_oldprise" class="form-control" required <?if ($upsel!='1') echo ("disabled") ?> id="upsel_oldprise" type="text" name="upsel_oldprise" value="<? if (($upsel_oldprise=="") AND ($upsel_oldprise=="")) echo $config['upsel']['upsel_oldprise']; else echo $upsel_oldprise;	 ?>" placeholder="Old prise"></div></div>

<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">New prise: <em>*</em></label><div class="col-sm-9"><input group="upsel_newprise" class="form-control" required <?if ($upsel!='1') echo ("disabled") ?> id="upsel_newprise" type="text" name="upsel_newprise" value="<? if (($upsel_newprise=="") AND ($upsel_newprise=="")) echo $config['upsel']['upsel_newprise']; else echo $upsel_newprise;	 ?>" placeholder="New prise"></div></div>

<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Sale %: <em>*</em></label><div class="col-sm-9"><input group="upsel_sale" class="form-control" required <?if ($upsel!='1') echo ("disabled") ?> id="upsel_sale" type="text" name="upsel_sale" value="<? if (($upsel_sale=="") AND ($upsel_newprise=="")) echo $config['upsel']['upsel_sale']; else echo $upsel_sale;	 ?>" placeholder="New prise"></div></div>

<div class="form-group">
<label class="col-sm-3 control-label">Комментарий: </label><div class="col-sm-9"><textarea class="form-control" rows="3" id="upsel_comment" name="upsel_comment" cols="70"><?= $upsel_comment ?></textarea>
<span class="help-block">Комментарий к upsell</span>
</div></div>
...
<label class="col-sm-3 control-label" for="upsel_delay">Задержка в секундах переадресации: </label><div class="col-sm-9"><input class="form-control" id="upsel_delay" group="upsell" <?if ($upsel!='1') echo ("disabled") ?> type="number" name="upsel_delay" value="<? if ($upsel_delay!="") echo $upsel_delay;	 ?>" placeholder="Задержка в секундах переадресации на сайт допродажи. Пусто - отключено"></div>
 ...
 <div class="panel panel-default">
  <div class="panel-heading">
   <h4 class="panel-title"> <i class="fa fa-cart-plus"></i>&#160;
       <a data-toggle="collapse" data-parent="#accordion" href="#upsell-block-2">
       2 Допродажа на странице "СПАСИБО." :&#160;</a>&#160;<i class="fa fa-caret-down" aria-hidden="true"></i>
	   <span id="upsell2" class="panel-heading-info hidden"><small>Есть не заполненные поля!</small></span>
      </h4>
  </div>
  <div id="upsell-block-2" class="panel-collapse collapse">
   <div class="panel-body">
	  <fieldset>
	   	 <legend><small>2 Блок допродажи на странице "спасибо"</small></legend>
	  <div class="form-group">
    <label class="col-sm-3 control-label" for="upsel">Активность: </label><div class="col-sm-9">
	 <select class="form-control" id="upsel_2" name="upsel_2" onchange="upscr_2(); return true;">
 
  <option <? if ($upsel_2==1) echo "selected"; ?> value="1">Включено</option>
  <option <? if ($upsel_2==0) echo "selected"; ?> value="0">Выключено</option>
   </select></div></div>
   <div id="ups_2" <? if ($upsel_2!='1') echo('class="hidden"'); ?>>
	 <div  id="upsel_title_group" class="form-group">
	 <label class="col-sm-3 control-label" for="upsel_title">Заголовок допродажи: <em>*</em></label><div class="col-sm-9"><input required group="upsell" class="form-control" id="upsel_title_2" <? if ($upsel_2!='1') echo ("disabled") ?> type="text" name="upsel_title_2" value="<? if ($upsel_title_2=="") echo $config['upsel']['upsel_title_2']; else echo $upsel_title_2;	 ?>" placeholder="Заголовок допродажи"></div></div>
 <div  id="upsel_pic_group" class="form-group">
 <label class="col-sm-3 control-label" for="upsel_pic">Картинка: <em>*</em></label>

<div class="col-sm-9">
<input group="upsell2" value="none"  class="form-control <? if ($upsel_pic_2) echo "hidden" ?>" <? if ($upsel_pic_2 != "") echo "disabled" ?> id="upsel_pic_2" <? if ($upsel_2!='1') echo ("disabled") ?> type="file" name="upsel_pic_2" accept="image/*" size="20" required >
 <? 
 if ($upsel_pic_2 != "") {echo ("<p id=\"upsel_pic_p_2\" "); 
 if ($upsel_2!='1') echo ("disabled"); 
 
 echo(">Выбранная картинка:<br><img width=\"100\" src=\"upsel_img/{$upsel_pic_2}\"></p>\n<input id=\"ups_pic_2\" type=\"hidden\" name=\"upsel_pic_2\" value=\"{$upsel_pic_2}\"><br>" ); 
 echo('<span id="on_upsell_pic_2" onclick="upspicscr_2(); return false;" class="btn btn-default">Заменить картинку</span>');
 } 
...
<div  id="upsel_pic_h_group" class="form-group">
 <label class="col-sm-3 control-label" for="upsel_pic_h">Высота картинки: <em>*</em></label><div class="col-sm-9"><input group="upsell" class="form-control" <?if ($upsel_2!='1') echo ("disabled") ?> id="upsel_pic_h_2" required type="text" name="upsel_pic_h_2" value="<? if ($upsel_pic_h_2=="") echo $config['upsel']['upsel_pic_h_2']; else echo $upsel_pic_h_2;	 ?>" placeholder="Высота картинки"></div></div>
 <div  id="upsel_url_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url">Ссылка на сайт допродажи: </label><div class="col-sm-9"><input class="form-control" id="upsel_url_2" type="text" name="upsel_url_2" group="upsell2" value="<?=$upsel_url_2; ?>" placeholder="Ссылка на сайт допродажи. Если ссылка не нужна - оставьте поле пустым"></div></div>
<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Подпись ccылки: <em>*</em></label><div class="col-sm-9"><input group="upsell" class="form-control"  id="upsel_url_title_2" type="text" name="upsel_url_title_2" value="<? if (($upsel_url_2=="") AND ($upsel_url_title_2=="")) echo $config['upsel']['upsel_url_title_2']; else echo $upsel_url_title_2;	 ?>" placeholder="Подпись ccылки на сайт с допродажей"></div></div>



<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Old prise: <em>*</em></label><div class="col-sm-9"><input group="upsel_oldprise2" class="form-control" required  id="upsel_oldprise_2" type="text" name="upsel_oldprise_2" value="<? if (($upsel_oldprise_2=="") AND ($upsel_oldprise_2=="")) echo $config['upsel']['upsel_oldprise_2']; else echo $upsel_oldprise_2;	 ?>" placeholder="Old prise"></div></div>

<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">New prise: <em>*</em></label><div class="col-sm-9"><input group="upsel_newprise" class="form-control" required id="upsel_newprise_2" type="text" name="upsel_newprise_2" value="<? if (($upsel_newprise_2=="") AND ($upsel_newprise_2=="")) echo $config['upsel']['upsel_newprise_2']; else echo $upsel_newprise_2;	 ?>" placeholder="New prise"></div></div>

<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Sale %: <em>*</em></label><div class="col-sm-9"><input group="upsel_sale" class="form-control" required id="upsel_sale_2" type="text" name="upsel_sale_2" value="<? if (($upsel_sale_2=="") AND ($upsel_newprise_2=="")) echo $config['upsel']['upsel_sale_2']; else echo $upsel_sale_2;	 ?>" placeholder="New prise"></div></div>

<div class="form-group">
<label class="col-sm-3 control-label">Комментарий: </label><div class="col-sm-9"><textarea class="form-control" rows="3" id="upsel_comment_2" name="upsel_comment_2" cols="70"><?= $upsel_comment_2 ?></textarea>
<span class="help-block">Комментарий к upsell</span>
</div></div>
...
<div  id="upsel_delay_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_delay">Задержка в секундах переадресации: </label><div class="col-sm-9">
<input class="form-control" id="upsel_delay_2" group="upsell" <?if ($upsel_2!='1') echo ("disabled") ?> type="number" name="upsel_delay_2" value="<? if ($upsel_delay_2!="") echo $upsel_delay_2;	 ?>" placeholder="Задержка в секундах переадресации на сайт допродажи. Пусто - отключено"></div>
</div>
		</div>
		<div class="form-group text-center">
		<input type="submit"  value="Сохранить" class="btn btn-primary">
 ...
 <div class="panel panel-default">
  <div class="panel-heading">
   <h4 class="panel-title"> <i class="fa fa-cart-plus"></i>&#160;
       <a data-toggle="collapse" data-parent="#accordion" href="#upsell-block-3">
       3 Допродажа на странице "СПАСИБО." :&#160;</a>&#160;<i class="fa fa-caret-down" aria-hidden="true"></i>
	   <span id="upsell3" class="panel-heading-info hidden"><small>Есть не заполненные поля!</small></span>
      </h4>
  </div>
  <div id="upsell-block-3" class="panel-collapse collapse">
   <div class="panel-body">
	  <fieldset>
	   	 <legend><small>3 Блок допродажи на странице "спасибо"</small></legend>
	  <div class="form-group">
    <label class="col-sm-3 control-label" for="upsel">Активность: </label><div class="col-sm-9">
	 <select class="form-control" id="upsel_3" name="upsel_3" onchange="upscr_3(); return true;">
 
  <option <? if ($upsel_3==1) echo "selected"; ?> value="1">Включено</option>
  <option <? if ($upsel_3==0) echo "selected"; ?> value="0">Выключено</option>
   
  </select></div></div>
   <div id="ups_3" <? if ($upsel_3!='1') echo('class="hidden"'); ?>>
	 <div  id="upsel_title_group" class="form-group">
	 <label class="col-sm-3 control-label" for="upsel_title">Заголовок допродажи: <em>*</em></label><div class="col-sm-9"><input required group="upsell" class="form-control" id="upsel_title_3" <? if ($upsel_3!='1') echo ("disabled") ?> type="text" name="upsel_title_3" value="<? if ($upsel_title_3=="") echo $config['upsel']['upsel_title_3']; else echo $upsel_title_3;	 ?>" placeholder="Заголовок допродажи"></div></div>
 <div  id="upsel_pic_group" class="form-group">
 <label class="col-sm-3 control-label" for="upsel_pic">Картинка: <em>*</em></label>

<div class="col-sm-9">
<input group="upsell3" value="none" class="form-control <? if ($upsel_pic_3!="") echo "hidden"  ?>" <? if ($upsel_pic_3!="") echo "disabled" ?> id="upsel_pic_3" <? if ($upsel_3!='1') echo ("disabled") ?> type="file" name="upsel_pic_3" accept="image/*" size="20" required >
 <? 
 if ($upsel_pic_3!="") {echo ("<p id=\"upsel_pic_p_3\" "); 
 if ($upsel_3!='1') echo ("disabled"); echo(">Выбранная картинка:<br><img width=\"100\" src=\"upsel_img/{$upsel_pic_3}\"></p>\n<input id=\"ups_pic_3\" type=\"hidden\" name=\"upsel_pic_3\" value=\"{$upsel_pic_3}\"><br>" ); 
 echo('<span id="on_upsell_pic_3" onclick="upspicscr_3(); return false;" class="btn btn-default">Заменить картинку</span>');} ?>
 </div></div>


<div  id="upsel_pic_h_group" class="form-group">
 <label class="col-sm-3 control-label" for="upsel_pic_h">Высота картинки: <em>*</em></label><div class="col-sm-9"><input group="upsell" class="form-control" <?if ($upsel_3!='1') echo ("disabled") ?> id="upsel_pic_h_3" required type="text" name="upsel_pic_h_3" value="<? if ($upsel_pic_h_3=="") echo $config['upsel']['upsel_pic_h_3']; else echo $upsel_pic_h_3;	 ?>" placeholder="Высота картинки"></div></div>
 <div  id="upsel_url_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url">Ссылка на сайт допродажи: </label><div class="col-sm-9"><input class="form-control" id="upsel_url_3" type="text" name="upsel_url_3" group="upsell3" value="<?=$upsel_url_3; ?>" placeholder="Ссылка на сайт допродажи. Если ссылка не нужна - оставьте поле пустым"></div></div>
<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Подпись ccылки: <em>*</em></label><div class="col-sm-9"><input group="upsell" class="form-control"  id="upsel_url_title_3" type="text" name="upsel_url_title_3" value="<? if (($upsel_url_3=="") AND ($upsel_url_title_3=="")) echo $config['upsel']['upsel_url_title_3']; else echo $upsel_url_title_3;	 ?>" placeholder="Подпись ccылки на сайт с допродажей"></div></div>



<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Old prise: <em>*</em></label><div class="col-sm-9"><input group="upsel_oldprise3" class="form-control" required  id="upsel_oldprise_3" type="text" name="upsel_oldprise_3" value="<? if (($upsel_oldprise_3=="") AND ($upsel_oldprise_3=="")) echo $config['upsel']['upsel_oldprise_3']; else echo $upsel_oldprise_3;	 ?>" placeholder="Old prise"></div></div>

<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">New prise: <em>*</em></label><div class="col-sm-9"><input group="upsel_newprise" class="form-control" required id="upsel_newprise_3" type="text" name="upsel_newprise_3" value="<? if (($upsel_newprise_3=="") AND ($upsel_newprise_3=="")) echo $config['upsel']['upsel_newprise_3']; else echo $upsel_newprise_3;	 ?>" placeholder="New prise"></div></div>

<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Sale %: <em>*</em></label><div class="col-sm-9"><input group="upsel_sale" class="form-control" required id="upsel_sale_3" type="text" name="upsel_sale_3" value="<? if (($upsel_sale_3=="") AND ($upsel_newprise_3=="")) echo $config['upsel']['upsel_sale_3']; else echo $upsel_sale_3;	 ?>" placeholder="New prise"></div></div>

<div class="form-group">
<label class="col-sm-3 control-label">Комментарий: </label><div class="col-sm-9"><textarea class="form-control" rows="3" id="upsel_comment_3" name="upsel_comment_3" cols="70"><?= $upsel_comment_3 ?></textarea>
<span class="help-block">Комментарий к upsell</span>
</div></div>
...
<div  id="upsel_delay_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_delay">Задержка в секундах переадресации: </label><div class="col-sm-9">
<input class="form-control" id="upsel_delay_3" group="upsell" <?if ($upsel_3!='1') echo ("disabled") ?> type="number" name="upsel_delay_3" value="<? if ($upsel_delay_3!="") echo $upsel_delay_3;	 ?>" placeholder="Задержка в секундах переадресации на сайт допродажи. Пусто - отключено"></div>
</div>
		</div>
		<div class="form-group text-center">
		<input type="submit"  value="Сохранить" class="btn btn-primary">
...
<div class="panel panel-default">
  <div class="panel-heading">
   <h4 class="panel-title"> <i class="fa fa-cart-plus"></i>&#160;
       <a data-toggle="collapse" data-parent="#accordion" href="#upsell-block-4">
       4 Допродажа на странице "СПАСИБО." :&#160;</a>&#160;<i class="fa fa-caret-down" aria-hidden="true"></i>
	   <span id="upsell4" class="panel-heading-info hidden"><small>Есть не заполненные поля!</small></span>
      </h4>
  </div>
  <div id="upsell-block-4" class="panel-collapse collapse">
   <div class="panel-body">
	  <fieldset>
	   	 <legend><small>4 Блок допродажи на странице "спасибо"</small></legend>
	  <div class="form-group">
    <label class="col-sm-3 control-label" for="upsel">Активность: </label><div class="col-sm-9">
	 <select class="form-control" id="upsel_4" name="upsel_4" onchange="upscr_4(); return true;">
 
  <option <? if ($upsel_4==1) echo "selected"; ?> value="1">Включено</option>
  <option <? if ($upsel_4==0) echo "selected"; ?> value="0">Выключено</option>
   
  </select></div></div>
   <div id="ups_4" <? if ($upsel_4!='1') echo('class="hidden"'); ?>>
	 <div  id="upsel_title_group" class="form-group">
	 <label class="col-sm-3 control-label" for="upsel_title">Заголовок допродажи: <em>*</em></label><div class="col-sm-9"><input required group="upsell" class="form-control" id="upsel_title_4" <? if ($upsel_4!='1') echo ("disabled") ?> type="text" name="upsel_title_4" value="<? if ($upsel_title_4=="") echo $config['upsel']['upsel_title_4']; else echo $upsel_title_4;	 ?>" placeholder="Заголовок допродажи"></div></div>
 <div  id="upsel_pic_group" class="form-group">
 <label class="col-sm-3 control-label" for="upsel_pic">Картинка: <em>*</em></label>

<div class="col-sm-9">
<input group="upsell4"  value="none" class="form-control <? if ($upsel_pic_4!="") echo "hidden" ?>" <? if ($upsel_pic_4!="") echo "disabled" ?> id="upsel_pic_4" <? if ($upsel_4!='1') echo ("disabled") ?> type="file" name="upsel_pic_4" accept="image/*" size="20" required >
 <? 
 if ($upsel_pic_4!="") {echo ("<p id=\"upsel_pic_p_4\" "); 
 if ($upsel_4!='1') echo ("disabled"); echo(">Выбранная картинка:<br><img width=\"100\" src=\"upsel_img/{$upsel_pic_4}\"></p>\n<input id=\"ups_pic_4\" type=\"hidden\" name=\"upsel_pic_4\" value=\"{$upsel_pic_4}\"><br>" ); 
 echo('<span id="on_upsell_pic_4" onclick="upspicscr_4(); return false;" class="btn btn-default">Заменить картинку</span>');} ?>
 </div></div>


<div  id="upsel_pic_h_group" class="form-group">
 <label class="col-sm-3 control-label" for="upsel_pic_h">Высота картинки: <em>*</em></label><div class="col-sm-9"><input group="upsell" class="form-control" <?if ($upsel_4!='1') echo ("disabled") ?> id="upsel_pic_h_4" required type="text" name="upsel_pic_h_4" value="<? if ($upsel_pic_h_4=="") echo $config['upsel']['upsel_pic_h_4']; else echo $upsel_pic_h_4;	 ?>" placeholder="Высота картинки"></div></div>
 <div  id="upsel_url_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url">Ссылка на сайт допродажи: </label><div class="col-sm-9"><input class="form-control" id="upsel_url_4" type="text" name="upsel_url_4" group="upsell4" value="<?=$upsel_url_4; ?>" placeholder="Ссылка на сайт допродажи. Если ссылка не нужна - оставьте поле пустым"></div></div>
<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Подпись ccылки: <em>*</em></label><div class="col-sm-9"><input group="upsell" class="form-control"  id="upsel_url_title_4" type="text" name="upsel_url_title_4" value="<? if (($upsel_url_4=="") AND ($upsel_url_title_4=="")) echo $config['upsel']['upsel_url_title_4']; else echo $upsel_url_title_4;	 ?>" placeholder="Подпись ccылки на сайт с допродажей"></div></div>



<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Old prise: <em>*</em></label><div class="col-sm-9"><input group="upsel_oldprise4" class="form-control" required  id="upsel_oldprise_4" type="text" name="upsel_oldprise_4" value="<? if (($upsel_oldprise_4=="") AND ($upsel_oldprise_4=="")) echo $config['upsel']['upsel_oldprise_4']; else echo $upsel_oldprise_4;	 ?>" placeholder="Old prise"></div></div>

<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">New prise: <em>*</em></label><div class="col-sm-9"><input group="upsel_newprise4" class="form-control" required id="upsel_newprise_4" type="text" name="upsel_newprise_4" value="<? if (($upsel_newprise_4=="") AND ($upsel_newprise_4=="")) echo $config['upsel']['upsel_newprise_4']; else echo $upsel_newprise_4;	 ?>" placeholder="New prise"></div></div>

<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Sale %: <em>*</em></label><div class="col-sm-9"><input group="upsel_sale4" class="form-control" required id="upsel_sale_4" type="text" name="upsel_sale_4" value="<? if (($upsel_sale_4=="") AND ($upsel_newprise_4=="")) echo $config['upsel']['upsel_sale_4']; else echo $upsel_sale_4;	 ?>" placeholder="New prise"></div></div>

<div class="form-group">
<label class="col-sm-3 control-label">Комментарий: </label><div class="col-sm-9"><textarea class="form-control" rows="3" id="upsel_comment_4" name="upsel_comment_4" cols="70"><?= $upsel_comment_4 ?></textarea>
<span class="help-block">Комментарий к upsell</span>
</div></div>
...
<div  id="upsel_delay_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_delay">Задержка в секундах переадресации: </label><div class="col-sm-9">
<input class="form-control" id="upsel_delay_4" group="upsell" <?if ($upsel_3!='1') echo ("disabled") ?> type="number" name="upsel_delay_4" value="<? if ($upsel_delay_4!="") echo $upsel_delay_4;	 ?>" placeholder="Задержка в секундах переадресации на сайт допродажи. Пусто - отключено"></div>
</div>
		</div>
		<div class="form-group text-center">
		<input type="submit"  value="Сохранить" class="btn btn-primary">
...
<div class="panel panel-default">
  <div class="panel-heading">
   <h4 class="panel-title"> <i class="fa fa-cart-plus"></i>&#160;
       <a data-toggle="collapse" data-parent="#accordion" href="#upsell-block-5">
       5 Допродажа на странице "СПАСИБО." :&#160;</a>&#160;<i class="fa fa-caret-down" aria-hidden="true"></i>
	   <span id="upsell5" class="panel-heading-info hidden"><small>Есть не заполненные поля!</small></span>
      </h4>
  </div>
  <div id="upsell-block-5" class="panel-collapse collapse">
   <div class="panel-body">
	  <fieldset>
	   	 <legend><small>5 Блок допродажи на странице "спасибо"</small></legend>
	  <div class="form-group">
    <label class="col-sm-3 control-label" for="upsel">Активность: </label><div class="col-sm-9">
	 <select class="form-control" id="upsel_5" name="upsel_5" onchange="upscr_5(); return true;">
 
  <option <? if ($upsel_5==1) echo "selected"; ?> value="1">Включено</option>
  <option <? if ($upsel_5==0) echo "selected"; ?> value="0">Выключено</option>
   
  </select></div></div>
   <div id="ups_5" <? if ($upsel_5!='1') echo('class="hidden"'); ?>>
	 <div  id="upsel_title_group" class="form-group">
	 <label class="col-sm-3 control-label" for="upsel_title">Заголовок допродажи: <em>*</em></label><div class="col-sm-9"><input required group="upsell" class="form-control" id="upsel_title_5" <? if ($upsel_5!='1') echo ("disabled") ?> type="text" name="upsel_title_5" value="<? if ($upsel_title_5=="") echo $config['upsel']['upsel_title_5']; else echo $upsel_title_5;	 ?>" placeholder="Заголовок допродажи"></div></div>
 <div  id="upsel_pic_group" class="form-group">
 <label class="col-sm-3 control-label" for="upsel_pic">Картинка: <em>*</em></label>

<div class="col-sm-9">

<input group="upsell5"  value="none"  class="form-control <? if ($upsel_pic_5!="") echo "hidden" ?>" <? if ($upsel_pic_5!="") echo "disabled" ?> id="upsel_pic_5" <? if ($upsel_5!='1') echo ("disabled") ?> type="file" name="upsel_pic_5" accept="image/*" size="20" required >

 <? 
 if ($upsel_pic_5!="") {echo ("<p id=\"upsel_pic_p_5\" "); 
 if ($upsel_5!='1') echo ("disabled"); echo(">Выбранная картинка:<br><img width=\"100\" src=\"upsel_img/{$upsel_pic_5}\"></p>\n<input id=\"ups_pic_5\" type=\"hidden\" name=\"upsel_pic_5\" value=\"{$upsel_pic_5}\"><br>" ); 
 echo('<span id="on_upsell_pic_5" onclick="upspicscr_5(); return false;" class="btn btn-default">Заменить картинку</span>');} ?>
 </div></div>


<div  id="upsel_pic_h_group" class="form-group">
 <label class="col-sm-3 control-label" for="upsel_pic_h">Высота картинки: <em>*</em></label><div class="col-sm-9"><input group="upsell" class="form-control" <?if ($upsel_5!='1') echo ("disabled") ?> id="upsel_pic_h_5" required type="text" name="upsel_pic_h_5" value="<? if ($upsel_pic_h_5=="") echo $config['upsel']['upsel_pic_h_5']; else echo $upsel_pic_h_5;	 ?>" placeholder="Высота картинки"></div></div>
 <div  id="upsel_url_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url">Ссылка на сайт допродажи: </label><div class="col-sm-9"><input class="form-control" id="upsel_url_5" type="text" name="upsel_url_5" group="upsell5" value="<?=$upsel_url_5; ?>" placeholder="Ссылка на сайт допродажи. Если ссылка не нужна - оставьте поле пустым"></div></div>
<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Подпись ccылки: <em>*</em></label><div class="col-sm-9"><input group="upsell" class="form-control"  id="upsel_url_title_5" type="text" name="upsel_url_title_5" value="<? if (($upsel_url_5=="") AND ($upsel_url_title_5=="")) echo $config['upsel']['upsel_url_title_5']; else echo $upsel_url_title_5;	 ?>" placeholder="Подпись ccылки на сайт с допродажей"></div></div>



<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Old prise: <em>*</em></label><div class="col-sm-9"><input group="upsel_oldprise5" class="form-control" required  id="upsel_oldprise_5" type="text" name="upsel_oldprise_5" value="<? if (($upsel_oldprise_5=="") AND ($upsel_oldprise_5=="")) echo $config['upsel']['upsel_oldprise_5']; else echo $upsel_oldprise_5;	 ?>" placeholder="Old prise"></div></div>

<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">New prise: <em>*</em></label><div class="col-sm-9"><input group="upsel_newprise5" class="form-control" required id="upsel_newprise_5" type="text" name="upsel_newprise_5" value="<? if (($upsel_newprise_5=="") AND ($upsel_newprise_5=="")) echo $config['upsel']['upsel_newprise_5']; else echo $upsel_newprise_5;	 ?>" placeholder="New prise"></div></div>

<div  id="upsel_url_title_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_url_title">Sale %: <em>*</em></label><div class="col-sm-9"><input group="upsel_sale5" class="form-control" required id="upsel_sale_5" type="text" name="upsel_sale_5" value="<? if (($upsel_sale_5=="") AND ($upsel_newprise_5=="")) echo $config['upsel']['upsel_sale_5']; else echo $upsel_sale_5;	 ?>" placeholder="New prise"></div></div>

<div class="form-group">
<label class="col-sm-3 control-label">Комментарий: </label><div class="col-sm-9"><textarea class="form-control" rows="3" id="upsel_comment_5" name="upsel_comment_5" cols="70"><?= $upsel_comment_5 ?></textarea>
<span class="help-block">Комментарий к upsell</span>
</div></div>
...
<div  id="upsel_delay_group" class="form-group">
<label class="col-sm-3 control-label" for="upsel_delay">Задержка в секундах переадресации: </label><div class="col-sm-9">
<input class="form-control" id="upsel_delay_5" group="upsell" <?if ($upsel_5!='1') echo ("disabled") ?> type="number" name="upsel_delay_5" value="<? if ($upsel_delay_5!="") echo $upsel_delay_5;	 ?>" placeholder="Задержка в секундах переадресации на сайт допродажи. Пусто - отключено"></div>
</div>
		</div>
		<div class="form-group text-center">
		<input type="submit"  value="Сохранить" class="btn btn-primary">
