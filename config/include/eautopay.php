...
Для получения <strong>customer_api_key</strong> отметьте чек-бокс "Разрешить получение всех заказов через API-интерфейс"</small> </div></div>
	 ...
	 </label><div class="col-sm-9"><input group="crmt" required class="form-control"  id="user_api_key" type="text" name="user_api_key" value="<?php echo   $user_api_key ?>" placeholder="Ключ доступа user_api_key "></div>
 </div>
	 ...
	 </label><div class="col-sm-9"><input class="form-control"  id="customer_api_key" type="text" name="customer_api_key" group="crmt" required value="<?php echo   $customer_api_key ?>" placeholder="Ключ доступа customer_api_key"></div>
 </div><div id="good_id_group" class="form-group">
	  <label class="col-sm-3 control-label" for="good_id">Код товара:<br><span>good_id</span> </label><div class="col-sm-9"><input class="form-control" group="crmt" required  id="good_id" type="text" name="good_id" value="<?php echo   $good_id ?>" placeholder="Код товара good_id"> </div>
 </div>
